  ...
  return (
    <div className={styles.marco_container}>
      <div className={styles.btn_seconds}>
        ...
        <div className={styles.btn_exit}>
          <img src={require("../../image/BOTON_GUARDAR.png")} alt="not-found" />
        </div>
        <div className={styles.btn_exit}>
          <img src={require("../../image/BOTON_EDITAR.png")} alt="not-found" />
        </div>
